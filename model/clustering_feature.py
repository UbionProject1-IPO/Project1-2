...
raw_data = pd.read_csv("data/주가수익률_raw/주가수익률_final_noSP.csv")
...
X0_clustered.to_csv("data/clustered/국면0_clustering.csv", encoding="utf-8-sig")
...
X1_clustered.to_csv("data/clustered/국면1_clustering.csv", encoding="utf-8-sig")
